...
<head>
    <meta charset="utf-8">
    <title>Checkout | Rootguard Technologies</title>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="it-consultation.php" class="dropdown-item active">IT Consultation</a>
        ...
        <div class="container">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="mb-4 mb-md-0">Checkout</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn" href="">IT Constultation</a>
        ...
        <div class="row " style="padding-right: 15px; padding-left: 15px;">
            ...
            <div class="row g-5">
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <span class="text-muted"><?php echo "$".$hours*300+99 ?></span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Total (USD)</span>
                            <strong><?php echo "$".($hours*300+99)-99 ?></strong>
                        </li>
                    </ul>
                ...
                <div class="col-md-7 col-lg-8 " style="min-width: 40rem;">
                    <form class="needs-validation" novalidate="novalidate" action="it-consultation.php" method="post">
                                    ...
                                    paypal.Buttons({
                                        ...
                                        createOrder: function (data, actions) {
                                            return actions.order.create({
                                                purchase_units: [{ "description": "Consultation Fee", "amount": { "currency_code": "USD", "value": 300 } }]
                                            });
                                        },
                        ...
                        <input class="w-100 btn btn-primary btn-lg" type="submit" value="submit" name="payment-submit">
                    </form>
                </div>
            </div>
        </div>
